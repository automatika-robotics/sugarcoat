...
def create_supported_type(ros_msg_type: type, converter: Optional[Callable] = None, callback: Optional[Callable] = None) -> type[SupportedType]:
    ...
    if callback:
        ...
        callback_class = type(
            f"{class_name}Callback", (callbacks.GenericCallback,), callback_class_attrs
        )
