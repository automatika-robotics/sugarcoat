...
:canonical: ros_sugar.core.fallbacks.Fallback.dictionary
:type: typing.Dict

```{autodoc2-docstring} ros_sugar.core.fallbacks.Fallback.dictionary
```
...
````{py:property} latest_status
:canonical: ros_sugar.core.fallbacks.ComponentFallbacks.latest_status
:type: int

```{autodoc2-docstring} ros_sugar.core.fallbacks.ComponentFallbacks.latest_status
```

````

````{py:property} json
:canonical: ros_sugar.core.fallbacks.ComponentFallbacks.json
:type: typing.Union[str, bytes, bytearray]

```{autodoc2-docstring} ros_sugar.core.fallbacks.ComponentFallbacks.json
```
