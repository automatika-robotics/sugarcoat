...
* - {py:obj}`add_additional_datatypes <ros_sugar.io.supported_types.add_additional_datatypes>`
  - ```{autodoc2-docstring} ros_sugar.io.supported_types.add_additional_datatypes
    :summary:
    ```
* - {py:obj}`get_ros_msg_fields_dict <ros_sugar.io.supported_types.get_ros_msg_fields_dict>`
  - ```{autodoc2-docstring} ros_sugar.io.supported_types.get_ros_msg_fields_dict
    :summary:
    ```
* - {py:obj}`set_ros_msg_from_dict <ros_sugar.io.supported_types.set_ros_msg_from_dict>`
  - ```{autodoc2-docstring} ros_sugar.io.supported_types.set_ros_msg_from_dict
    :summary:
    ```
````
...
````{py:function} get_ros_msg_fields_dict(msg_class: type) -> typing.Dict[str, typing.Any]
:canonical: ros_sugar.io.supported_types.get_ros_msg_fields_dict

```{autodoc2-docstring} ros_sugar.io.supported_types.get_ros_msg_fields_dict
```
````

````{py:function} set_ros_msg_from_dict(msg_class: type, data_dict: typing.Dict[str, typing.Any]) -> typing.Any
:canonical: ros_sugar.io.supported_types.set_ros_msg_from_dict
...
````{py:method} convert(vx: float, vy: float, omega: float, **_) -> geometry_msgs.msg.Twist
:canonical: ros_sugar.io.supported_types.Twist.convert
:classmethod:

```{autodoc2-docstring} ros_sugar.io.supported_types.Twist.convert
```
